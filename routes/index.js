...
var sendMail = function(email, token) {
    var transporter = nodemailer.createTransport('smtps://nobi%40gmail.com:nobit1123@smtp.gmail.com');

    var mailOptions = {
        from: 'nobi@gmail.com', // sender address 
